...
const GRAPH_WITH_STABLE_DRAG_REF = `
...
if (startIdx !== -1 && endIdx !== -1) {
  src = src.slice(0, startIdx) + GRAPH_WITH_STABLE_DRAG_REF + '\n\n' + src.slice(endIdx);
  console.log('[OK] Updated FinancialGraphTab with draggingNodeRef and window mouse listeners');
} else {
