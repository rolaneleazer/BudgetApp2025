...
const GRAPH_WITH_ZOOM_AND_DRAG = `
...
if (startIdx !== -1 && endIdx !== -1) {
  src = src.slice(0, startIdx) + GRAPH_WITH_ZOOM_AND_DRAG + '\n\n' + src.slice(endIdx);
  console.log('[OK] Updated FinancialGraphTab with Mouse Wheel Zoom and Pinpoint Dragging');
} else {
